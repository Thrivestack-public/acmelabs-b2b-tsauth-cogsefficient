export const textConstants = {
  ...
  SHARED_DATA_MODAL_DESC_ACKNOWLEDGE: "ACKNOWLEDGE DATA.",
  ...
  SHARED_DATA_MODAL_INFO_ACKNOWLEDGE: "Acknowledge info.",
  ...
  ACKNOWLEDGE_DOCS_LINK: 'https://docs.app.thrivestack.ai/getting-started/self-serve/customization#subscribe-to-tenant-requests',
