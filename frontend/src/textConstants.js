export const textConstants = {
  ...
  SHARED_DATA_MODAL_DESC_ONBOARDING_REDIRECT: "You can configure a home or product's page of your choice by setting the configuration.",
